...
from .shrinker import Shrinkable, shrink_to_minimal, IntegerShrinker, StringShrinker
...
class PropertyTestError(Exception):
    ...
    def __init__(self, message: str, failing_inputs: Optional[List[Any]] = None, 
...
class Property:
    ...
    def __init__(self, property_func: Callable[..., bool], num_runs: int = 100, 
    ...
    def _shrink_failing_inputs(self, inputs: List[Any], generators: List[Generator[Any]]) -> List[Any]:
...
def property_test(
    *generators: Generator[Any],
    ...
    def decorator(func: Callable[..., bool]) -> Callable[[], bool]:
        def wrapper() -> bool:
            return for_all(func, *generators, num_runs=num_runs, seed=seed)
        return wrapper
    return decorator
