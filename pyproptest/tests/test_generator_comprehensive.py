...
class TestComprehensiveGenerators:
    ...
    def test_string_generator_generates_ascii_strings(self):
        ...
        rng = random.Random(42)
        string_gen = Gen.str(min_length=3, max_length=8, charset="abcdefghijklmnopqrstuvwxyz")
    ...
    def test_list_generator_with_various_sizes(self):
        ...
        rng = random.Random(42)
        list_gen = Gen.list(Gen.int(min_value=0, max_value=10), min_length=2, max_length=5)
    ...
    def test_list_generator_with_empty_list(self):
        ...
        rng = random.Random(42)
        list_gen = Gen.list(Gen.int(min_value=0, max_value=10), min_length=0, max_length=3)
