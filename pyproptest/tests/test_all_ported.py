...
import pytest
from pyproptest import Gen, run_for_all, Property, PropertyTestError, Shrinkable
...
class TestAllPortedFunctionality:
    ...
    def test_collection_generators_work(self):
        ...
        # Test dict generator
        dict_gen = Gen.dict(Gen.str(min_length=1, max_length=2), Gen.int(min_value=0, max_value=10))
